...
public class NovaModelUtil {
    ...
    // create a function to chat with nova where passing prompt and image file of cheque and extranct bank account details from cheque
    public String chatWithNova(String userMessage, String imageToSearch) {
        try {
            String modelId = "anthropic.claude-3-sonnet-20240229-v1:0";
